...
namespace FlakeTrain.FlakeController.Locomotive
{
    ...
    public class LocomotiveFunction
    {
        ...
        {
            Name = string.Format(i18n.FlakeControllerLocomotive.Function, fNumber.ToString());
            Description = string.Format(i18n.FlakeControllerLocomotive.EmptyDescription, fNumber.ToString());
